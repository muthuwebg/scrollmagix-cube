...
$(document).ready(function () {
    ...
    var scene = new ScrollScene({ offset: 500}).setTween( new TweenMax.to('#top_cube', 2, { css: { transform: 'translate(0, 0)' }
			}), 1000);
    var scene2 = new ScrollScene({ offset: 500}).setTween( new TweenMax.to('#Success', 2, { css: { transform: 'translate(0, 0)', opacity: '1' }
			}), 1000);
    var scene3 = new ScrollScene({ offset: 500}).setTween( new TweenMax.to('#Sales', 2, { css: { transform: 'translate(0, 0)', opacity: '1' }
			}), 1000);
    var scene4 = new ScrollScene({ offset: 500}).setTween( new TweenMax.to('#finance', 2, { css: { transform: 'translate(0, 0)', opacity: '1' }
			}), 1000);
    var scene5 = new ScrollScene({ offset: 500}).setTween( new TweenMax.to('#marketing', 2, { css: { transform: 'translate(0, 0)', opacity: '1' }
			}), 1000);
